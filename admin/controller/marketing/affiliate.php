...
class ControllerMarketingAffiliate extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['affiliates'][] = array(
				...
				'name'         => $result['name'],
				'email'        => $result['email'],
				'balance'      => $this->db->query("SELECT * FROM " . DB_PREFIX . "affiliate_order WHERE affiliate_id = '" . $result['affiliate_id'] . "'")->num_rows,
	...
	protected function getForm() {
		...
		$data['entry_adres'] = $this->language->get('entry_adres');
		$data['entry_rabota'] = $this->language->get('entry_rabota');
		$data['entry_usluga'] = $this->language->get('entry_usluga');
		$data['entry_telefon'] = $this->language->get('entry_telefon');
		$data['entry_text_category'] = $this->language->get('entry_text_category');
		$data['entry_text_zone'] = $this->language->get('entry_text_zone');
		$data['entry_text_city'] = $this->language->get('entry_text_city');
		$data['entry_text_adres'] = $this->language->get('entry_text_adres');
		$data['entry_text_rabota'] = $this->language->get('entry_text_rabota');
		$data['entry_text_usluga'] = $this->language->get('entry_text_usluga');
		$data['entry_text_telefon'] = $this->language->get('entry_text_telefon');
        ...
        $data['tab_centr'] = $this->language->get('tab_centr');
        $data['tab_zakaz'] = $this->language->get('tab_zakaz');
        ...
        $data['column_name'] = $this->language->get('column_name');
        $data['column_centr'] = $this->language->get('column_centr');
        ...
        /*---------- Партнерка ------------- */
        $data['orders'] = array();
        $data['centr_values'] = array();
        if (!empty($this->request->get['affiliate_id'])) {
        /*---- Центры ----*/
        $this->load->model('marketing/affiliate');
        $data['centr_values'] = $this->model_marketing_affiliate->getCentr($this->request->get['affiliate_id']);
        $data['categories'] = $this->model_marketing_affiliate->getAffCategories();

       /*---- end центры ----*/
       /*---- Заказы ----*/
       $order_info = $this->model_marketing_affiliate->order($this->request->get['affiliate_id']);

       if ($order_info) {
        $data['orders'] = $this->model_marketing_affiliate->getOrder($order_info);
        }
       /*---- end Заказы ----*/
       }
       /*---- end Партнерка ----*/
