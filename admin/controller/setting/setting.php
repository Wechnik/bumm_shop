...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		if (isset($this->request->post['config_filter_metatag_start'])) {
			$data['config_filter_metatag_start'] = $this->request->post['config_filter_metatag_start'];
		} else {
			$data['config_filter_metatag_start'] = $this->config->get('config_filter_metatag_start');
		}

		if (isset($this->request->post['config_filter_metatag_end'])) {
			$data['config_filter_metatag_end'] = $this->request->post['config_filter_metatag_end'];
		} else {
			$data['config_filter_metatag_end'] = $this->config->get('config_filter_metatag_end');
		}
		...
		if (isset($this->request->post['config_coordinates'])) {
			$data['config_coordinates'] = $this->request->post['config_coordinates'];
		} else {
			$data['config_coordinates'] = $this->config->get('config_coordinates');
		}

		if (isset($this->request->post['config_coordinates2'])) {
			$data['config_coordinates2'] = $this->request->post['config_coordinates2'];
		} else {
			$data['config_coordinates2'] = $this->config->get('config_coordinates2');
		}
		...
		if (isset($this->request->post['config_ga_analytics'])) {
			$data['config_ga_analytics'] = $this->request->post['config_ga_analytics'];
		} else {
			$data['config_ga_analytics'] = $this->config->get('config_ga_analytics');
		}

		if (isset($this->request->post['config_ya_metric'])) {
			$data['config_ya_metric'] = $this->request->post['config_ya_metric'];
		} else {
			$data['config_ya_metric'] = $this->config->get('config_ya_metric');
		}
