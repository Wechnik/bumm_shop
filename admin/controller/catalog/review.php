...
class ControllerCatalogReview extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['reply_to_review'])) {
			$data['reply_to_review'] = $this->request->post['reply_to_review'];
		} elseif (!empty($review_info)) {
			$data['reply_to_review'] = $review_info['reply_to_review'];
		} else {
			$data['reply_to_review'] = '';
		}
