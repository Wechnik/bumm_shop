...
class ControllerCatalogTab extends Controller {
	...
	private function getList() {
		...
		$results = $this->model_catalog_tab->getTabs($req_data);
		...
		$data['text_form'] 			= $this->language->get('text_list');
	...
	private function getForm() {
		...
		$data['entry_position_help']= $this->language->get('entry_position_help');
		$data['entry_show_empty']	= $this->language->get('entry_show_empty');
		$data['entry_show_empty_help']= $this->language->get('entry_show_empty_help');
