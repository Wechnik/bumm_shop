...
class ControllerCatalogProductGroups extends Controller {
	private $error = array();
	...
	public function index() {
        ...
        $data['products'] = $this->model_catalog_product_groups->getProducts();


        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {

            $this->model_catalog_product_groups->editCustomTabs($this->request->post);
        ...
        $data['products_tab'] = $this->model_catalog_product_groups->getTabProductsByCategory($this->category_id);

        $checked_tab_products = $this->model_catalog_product_groups->getTabProductsChecked();
...
//        $data['products_tab'] = $this->model_catalog_product_groups->getTabProductsChecked();
        ...
        $this->response->setOutput($this->load->view('catalog/product_groups', $data));
