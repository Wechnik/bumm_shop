<?php
class ControllerCustomerCustomerModerator extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$customer_total = $this->model_customer_customer->getTotalCustomers($filter_data, 3);

		$results = $this->model_customer_customer->getCustomers($filter_data, $customer_group_id);
	...
	protected function getForm() {
        ...
        $this->document->addStyle('view/javascript/c6v/typeahead/typeahead.css');
        $this->document->addScript('view/javascript/c6v/typeahead/typeahead.bundle.min.js');
        $this->document->addScript('view/javascript/c6v/c6v.js');
	...
	public function ip() {
		...
		foreach ($results as $result) {
			$data['ips'][] = array(
				'ip'         => $result['ip'],
				'total'      => $this->model_customer_customer->getTotalCustomersByIp($result['ip'], $customer_group_id),
