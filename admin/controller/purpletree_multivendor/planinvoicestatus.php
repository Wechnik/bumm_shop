<?php
class ControllerPurpletreeMultivendorPlaninvoicestatus extends Controller {
		private $error = array();
		...
		public function index() {
			...
			$this->load->model('purpletree_multivendor/planinvoicestatus');
		...
		public function add() {
			if (!$this->customer->validateSeller()) {
				$this->load->language('purpletree_multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('purpletree_multivendor/planinvoicestatus', 'token=' . $this->session->data['token'] . $url, true));
			}
			$this->load->language('purpletree_multivendor/planinvoicestatus');
			...
			if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()){
				...
				$this->model_purpletree_multivendor_planinvoicestatus->addSubscriptionplaninvoicestatus($this->request->post);
		...
		public function edit() {
			...
			$this->load->model('purpletree_multivendor/planinvoicestatus');
			if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()){
				$this->model_purpletree_multivendor_planinvoicestatus->editSubscriptionplaninvoicestatus($this->request->get['status_id'], $this->request->post);
			...
			if (isset($this->request->post['selected'])){
				...
				foreach ($this->request->post['selected'] as $status_id) {
					...
					if ($status_id != 1 && $status_id != 2){
						$this->model_purpletree_multivendor_planinvoicestatus->deleteSubscriptionplaninvoicestatus($status_id);
		...
		protected function getList() {	
			...
			'href' => $this->url->link('purpletree_multivendor/planinvoicestatus', 'token=' . $this->session->data['token'] . $url, true)
			);
			
			$data['add'] = $this->url->link('purpletree_multivendor/planinvoicestatus/add', 'token=' . $this->session->data['token'] . $url, true);
			$data['delete'] = $this->url->link('purpletree_multivendor/planinvoicestatus/delete', 'token=' . $this->session->data['token'] . $url, true);	
			...
			$subscriptionplaninvoicestatus_total = $this->model_purpletree_multivendor_planinvoicestatus->getTotalSubscriptionplaninvoicestatus();		
			
			$results = $this->model_purpletree_multivendor_planinvoicestatus->getSubscriptionplaninvoicestatus($invoice_data);
			...
			foreach ($results as $result) {	
				...
				'edit'           => $this->url->link('purpletree_multivendor/planinvoicestatus/edit', 'token=' . $this->session->data['token'] . '&status_id=' . $result['status_id'] . $url, true)
				);
			}
			...
			$pagination->url = $this->url->link('purpletree_multivendor/planinvoicestatus', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
			...
			$data['column_modified_date'] = $this->language->get('column_modified_date');
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/planinvoicestatus_list', $data));
		}
		...
		protected function getForm() {	
			...
			if (!isset($this->request->get['status_id'])) {
				$data['action'] = $this->url->link('purpletree_multivendor/planinvoicestatus/add', 'token=' . $this->session->data['token'] . $url, true);
				} else {
				$data['action'] = $this->url->link('purpletree_multivendor/planinvoicestatus/edit', 'token=' . $this->session->data['token'] . '&status_id=' . $this->request->get['status_id'] . $url, true);
				
			}
			
			$data['cancel'] = $this->url->link('purpletree_multivendor/planinvoicestatus', 'token=' . $this->session->data['token'] . $url, true);
			...
			if (isset($this->request->post['subscriptionplan_invoice_status'])) {
				...
				$data['subscriptionplan_invoice_status'] = $this->model_purpletree_multivendor_planinvoicestatus->getInvoicestatus($this->request->get['status_id']);
				} else {
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/planinvoicestatus_form', $data));
		}
		...
		protected function validateDelete() {
			if (!$this->user->hasPermission('modify', 'purpletree_multivendor/planinvoicestatus')) {
