<?php
class ControllerPurpletreeMultivendorSellerreviews extends Controller {
		private $error = array();
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_purpletree_multivendor_sellerreview->editReview($this->request->get['id'], $this->request->post);
				...
				$this->response->redirect($this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . $url, true));
			}
		...
		public function delete() {
			...
			if (isset($this->request->post['selected']) ) {
				foreach ($this->request->post['selected'] as $review_id) {
					$this->model_purpletree_multivendor_sellerreview->deleteReview($review_id);
				}
		...
		protected function getList() {
			...
			'href' => $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . $url, true)
			);
			
			$data['add'] = $this->url->link('purpletree_multivendor/sellerreviews/add', 'token=' . $this->session->data['token'] . $url, true);
			$data['delete'] = $this->url->link('purpletree_multivendor/sellerreviews/delete', 'token=' . $this->session->data['token'] . $url, true);
			...
			foreach ($results as $result) {
				...
				if (!$this->customer->validateSeller()) {
					...
					$edit = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'], true);
					} else {
					$edit = $this->url->link('purpletree_multivendor/sellerreviews/edit', 'token=' . $this->session->data['token'] . '&id=' . $result['id'].'&seller_id='.$result['seller_id'] . $url, true);
				}
				
				$data['reviews'][] = array(
				'id'     => $result['id'],
				'store_name'     => $this->model_purpletree_multivendor_sellerreview->getStoreName($result['seller_id']),
			...
			$data['sort_customer'] = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . '&sort=customer_name' . $url, true);
			$data['sort_title'] = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . '&sort=pvr.review_title' . $url, true);
			$data['sort_rating'] = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . '&sort=pvr.rating' . $url, true);
			$data['sort_status'] = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . '&sort=pvr.status' . $url, true);
			$data['sort_date_added'] = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . '&sort=pvr.created_at' . $url, true);
			...
			$pagination->url = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/review_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['id'])) {
				$data['action'] = $this->url->link('purpletree_multivendor/sellerreviews/add', 'token=' . $this->session->data['token'] . $url, true);
				} else {
				$data['action'] = $this->url->link('purpletree_multivendor/sellerreviews/edit', 'token=' . $this->session->data['token'] . '&id=' . $this->request->get['id'].'&seller_id='. $this->request->get['seller_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('purpletree_multivendor/sellerreviews', 'token=' . $this->session->data['token'] . $url, true);
			
			if (isset($this->request->get['id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
				$review_info = $this->model_purpletree_multivendor_sellerreview->getReview($this->request->get['id']);
			}
			...
			if (!empty($review_info['seller_id'])) {
				$data['seller_name'] = $this->model_purpletree_multivendor_sellerreview->getSellerName($review_info['seller_id']);
				} else {
				$data['seller_name'] = '';
			}
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/review_form', $data));
		}
		
		protected function validateForm() {
			if (!$this->user->hasPermission('modify', 'purpletree_multivendor/sellerreviews')) {
