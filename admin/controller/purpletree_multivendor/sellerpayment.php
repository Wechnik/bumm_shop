<?php
class ControllerPurpletreeMultivendorSellerpayment extends Controller{
		private $error = array();
		public function index(){
			if (!$this->customer->validateSeller()) {
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('purpletree_multivendor/stores', 'token=' . $this->session->data['token'], true));
			}
		...
		$data['breadcrumbs'] = array();
			...
			'href' => $this->url->link('purpletree_multivendor/sellerpayment', '', true)
			);
			...
			$pagination->url = $this->url->link('purpletree_multivendor/sellerpayment', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/payment_list', $data));
		}
}
?>