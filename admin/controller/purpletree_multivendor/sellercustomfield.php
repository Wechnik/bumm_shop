<?php
class ControllerPurpletreeMultivendorSellercustomfield extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->load->model('purpletree_multivendor/sellercustomfield');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_purpletree_multivendor_sellercustomfield->addCustomField($this->request->post);
			...
			$this->response->redirect($this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_purpletree_multivendor_sellercustomfield->editCustomField($this->request->get['custom_field_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $custom_field_id) {
				$this->model_purpletree_multivendor_sellercustomfield->deleteCustomField($custom_field_id);
			}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . $url, true)
		);
		...
		$data['add'] = $this->url->link('purpletree_multivendor/sellercustomfield/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('purpletree_multivendor/sellercustomfield/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		$custom_field_total = $this->model_purpletree_multivendor_sellercustomfield->getTotalCustomFields();

		$results = $this->model_purpletree_multivendor_sellercustomfield->getCustomFields($filter_data);
		...
		foreach ($results as $result) {
			...
			$data['custom_fields'][] = array(
				...
				'edit'            => $this->url->link('purpletree_multivendor/sellercustomfield/edit', 'token=' . $this->session->data['token'] . '&custom_field_id=' . $result['custom_field_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . '&sort=cfd.name' . $url, true);
		$data['sort_location'] = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.location' . $url, true);
		$data['sort_type'] = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.type' . $url, true);
		$data['sort_status'] = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.status' . $url, true);
		$data['sort_sort_order'] = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('purpletree_multivendor/custom_field_list', $data));
	}
	...
	protected function getForm() {
        ...
        $data['entry_text_one'] = $this->language->get('entry_text_one');
        $data['entry_text_two'] = $this->language->get('entry_text_two');
        $data['entry_text_three'] = $this->language->get('entry_text_three');
        $data['heading_title'] = $this->language->get('heading_title');
		...
		if (!isset($this->request->get['custom_field_id'])) {
			$data['action'] = $this->url->link('purpletree_multivendor/sellercustomfield/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('purpletree_multivendor/sellercustomfield/edit', 'token=' . $this->session->data['token'] . '&custom_field_id=' . $this->request->get['custom_field_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('purpletree_multivendor/sellercustomfield', 'token=' . $this->session->data['token'] . $url, true);

		if (isset($this->request->get['custom_field_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$custom_field_info = $this->model_purpletree_multivendor_sellercustomfield->getCustomField($this->request->get['custom_field_id']);
		}
		...
		if (isset($this->request->post['custom_field_description'])) {
			...
			$data['custom_field_description'] = $this->model_purpletree_multivendor_sellercustomfield->getCustomFieldDescriptions($this->request->get['custom_field_id']);
		} else {
		...
		if (isset($this->request->post['custom_field_value'])) {
			...
			$custom_field_values = $this->model_purpletree_multivendor_sellercustomfield->getCustomFieldValueDescriptions($this->request->get['custom_field_id']);
		} else {
		...
		if (isset($this->request->post['custom_field_customer_group'])) {
			...
			$custom_field_customer_groups = $this->model_purpletree_multivendor_sellercustomfield->getCustomFieldCustomerGroups($this->request->get['custom_field_id']);
		} else {
		...
		$this->response->setOutput($this->load->view('purpletree_multivendor/custom_field_form', $data));
	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'purpletree_multivendor/sellercustomfield')) {
