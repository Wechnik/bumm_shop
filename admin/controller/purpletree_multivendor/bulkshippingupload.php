<?php
class ControllerPurpletreeMultivendorBulkshippingupload extends Controller{
		private $error = array();
		...
		public function upload(){
			if (!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('purpletree_multivendor/bulkshippingupload', 'token=' . $this->session->data['token'] . $url, true));
			}
			$cwd = getcwd();
		...
		public function getData(){
			...
			'href' => $this->url->link('purpletree_multivendor/bulkshippingupload', 'token=' . $this->session->data['token'] . $url, true)
			);		
			...
			$data['export'] = $this->url->link('purpletree_multivendor/bulkshippingupload/export', 'token=' . $this->session->data['token'], true);	
			
			$data['upload'] = $this->url->link('purpletree_multivendor/bulkshippingupload/upload', 'token=' . $this->session->data['token'], true);	
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/bulkshipping_upload', $data));
		}
	}
