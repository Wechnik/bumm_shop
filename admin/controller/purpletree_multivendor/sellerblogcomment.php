<?php
class ControllerPurpletreeMultivendorSellerblogcomment extends Controller {
		private $error = array();
		...
		public function index() {
			...
			$this->load->model('purpletree_multivendor/sellerblogcomment');
		...
		public function add() {
			if (!$this->customer->validateSeller()) {
				$this->load->language('purpletree_multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('purpletree_multivendor/sellerblogcomment', 'token=' . $this->session->data['token'] . $url, true));
			}
			$this->load->language('purpletree_multivendor/sellerblogcomment');
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_purpletree_multivendor_sellerblogcomment->addComment($this->request->post);
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_purpletree_multivendor_sellerblogcomment->editComment($this->request->get['comment_id'], $this->request->post);
		...
		public function delete() {
			...
			if (isset($this->request->post['selected']) && $this->validateDelete()) {
				foreach ($this->request->post['selected'] as $comment_id) {
					$this->model_purpletree_multivendor_sellerblogcomment->deleteComment($comment_id);
				}
		...
		protected function getList() {
			...
			'href' => $this->url->link('purpletree_multivendor/sellerblogcomment', 'token=' . $this->session->data['token'] . $url, true)
			);
			
			$data['add'] = $this->url->link('purpletree_multivendor/sellerblogcomment/add', 'token=' . $this->session->data['token'] . $url, true);
			$data['delete'] = $this->url->link('purpletree_multivendor/sellerblogcomment/delete', 'token=' . $this->session->data['token'] . $url, true);
			...
			$comment_total = $this->model_purpletree_multivendor_sellerblogcomment->getTotalComments($filter_data);
			
			$results = $this->model_purpletree_multivendor_sellerblogcomment->getComments($filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('purpletree_multivendor/sellerblogcomment/edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $result['blog_comment_id'] . $url, true)
				);
			}
			...
			$pagination->url = $this->url->link('purpletree_multivendor/sellerblogcomment', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/sellerblogcomment_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['comment_id'])) {
				$data['action'] = $this->url->link('purpletree_multivendor/sellerblogcomment/add', 'token=' . $this->session->data['token'] . $url, true);
				} else {
				$data['action'] = $this->url->link('purpletree_multivendor/sellerblogcomment/edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('purpletree_multivendor/sellerblogcomment', 'token=' . $this->session->data['token'] . $url, true);
			
			if (isset($this->request->get['comment_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
				$comment_info = $this->model_purpletree_multivendor_sellerblogcomment->getComment($this->request->get['comment_id']);
			}
			...
			$this->response->setOutput($this->load->view('purpletree_multivendor/sellerblogcomment_form', $data));
		}
		
		protected function validateForm() {
			if (!$this->user->hasPermission('modify', 'purpletree_multivendor/sellerblogcomment')) {
