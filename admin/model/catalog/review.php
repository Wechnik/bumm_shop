...
//		}
        ...
        if (!empty($data['filter_product'])) {
            $sql .= " AND pd.meta_h1 LIKE '" . $this->db->escape($data['filter_product']) . "%'";
        }
