...
class ModelCustomerCustomer extends Model {
	...
	public function getTotalCustomers($data = array(), $customer_group_id = 1) {
		...
		if(!$implode){
            ...
            $sql .= " WHERE  customer_group_id = '" . $customer_group_id . "'";
