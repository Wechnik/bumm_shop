<?php
class ModelPurpletreeMultivendorGeozone extends Model {
		public function addSellerGeoZone($data) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "purpletree_vendor_geozone SET geo_zone_id = '" . (int)$geo_zone_id . "', seller_id = '" . (int)$data['seller_id'] . "', weight_from = '" . (float)$data['weight_from'] . "', weight_to = '" . (float)$data['weight_to'] . "', price = '" . (int)$data['price'] . "'");
		...
		public function editSellerGeoZone($geo_zone_id, $data) {
			...
			$this->db->query("UPDATE " . DB_PREFIX . "purpletree_vendor_geozone SET seller_id = '" . (int)$data['seller_id'] . "', weight_from = '" . (float)$data['weight_from'] . "', weight_to = '" . (float)$data['weight_to'] . "', price = '" . (int)$data['price'] . "' WHERE geo_zone_id = '" . (int)$geo_zone_id . "'");
