<?php
$_['heading_title'] = 'ProgRoman - CityManager Pro ' . \progroman\CityManager\CityManager::VERSION;
...
$_['entry_customer_group_high_priority'] = 'Приоритет над группой зарегистрированного пользователя<span class="help" data-toggle="tooltip" title="Группа всегда устанавливается в зависимости от города и перекрывает группу зарегистрированного пользователя"></span>';
$_['entry_customer_group_for_new_user'] = 'Присваивать группу города пользователю при регистрации<span class="help" data-toggle="tooltip" title="При регистрации новому пользователю присвоится группа текущего города, в дальнейшем у него всегда будет эта группа"></span>';
...
$_['entry_bind_subdomain'] = 'Привязать город к поддомену / URL<span class="help" data-toggle="tooltip" title="Город зависит от поддомена и только, если его нет в списке, определяется по IP"></span>';
$_['entry_enabled_redirects'] = 'Включить редиректы';
$_['entry_fias_in_qs'] = 'Добавлять ID города в строке запроса<span class="help" data-toggle="tooltip" title="Включите, если магазин работает на разных доменах">';
...
$_['button_customer_group'] = 'Создать группу покупателей';
