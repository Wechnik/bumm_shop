                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][city]" value="<?php echo $address['city']; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city<?php echo $address_row; ?>" class="form-control typeahead" />
...
function addAddress() {
	...
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][city]" value="" placeholder="<?php echo $entry_city; ?>" id="input-city' + address_row + '" class="form-control typeahead" /></div>';
	html += '  </div>';
