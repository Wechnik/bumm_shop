          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_meta_name" value="<?php echo $filter_meta_name; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name" class="form-control" />
              </div>
              <div class="form-group">
...
$('#button-filter').on('click', function() {
	...
	var filter_meta_name = $('input[name=\'filter_meta_name\']').val();

	if (filter_meta_name) {
		url += '&filter_name=' + encodeURIComponent(filter_meta_name);
	}
...
//--></script>
  <script type="text/javascript"><!--
$('input[name=\'filter_meta_name\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'filter_meta_name\']').val(item['label']);
	}
});
