...
<!--	          <li><a href="#tab-product-configuration" data-toggle="tab">Группы вкладок</a></li>-->
          </ul>
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-additional-description<?php echo $language['language_id']; ?>"><?php echo $entry_additional_description; ?></label>
                        <div class="col-sm-10">
                            <textarea name="category_description[<?php echo $language['language_id']; ?>][additional_description]" placeholder="<?php echo $entry_additional_description; ?>" id="input-additional-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['additional_description'] : ''; ?></textarea>
                        </div>
                    </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Показывать на главной</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <?php if ($show_main_page) { ?>
                                <input type="radio" name="show_main_page" value="1" checked="checked" />
                                Да
                            <?php } else { ?>
                                <input type="radio" name="show_main_page" value="1" />
                                Да
                            <?php } ?>
                        </label>
                        <label class="radio-inline">
                            <?php if (!$show_main_page) { ?>
                                <input type="radio" name="show_main_page" value="0" checked="checked" />
                                Нет
                            <?php } else { ?>
                                <input type="radio" name="show_main_page" value="0" />
                                Нет
                            <?php } ?>
                        </label>
                    </div>
            ...
            <div class="tab-pane" id="tab-design">
	          ...
	          <?php include(DIR_APPLICATION.'view/template/catalog/nkf_autocategory.tpl'); ?>
	          
<!--	          <div class="tab-pane" id="tab-product-configuration">-->
<!--		          -->
<!--		          --><?php //foreach ($user_groups as $user_group) { ?>
<!--			          <div class="form-group">-->
<!--				          <label class="col-sm-2 control-label">--><?php //echo $user_group['name']; ?><!--</label>-->
<!--				          <div class="col-sm-10">-->
<!--					          <div class="well well-sm"-->
<!--					               style="min-height: 150px;max-height: 500px;overflow: auto;">-->
<!--						          <table class="table table-striped">-->
<!--							          --><?php //foreach ($field_list_arr as $field_list_k => $field_list_v) { ?>
<!--								          <tr>-->
<!--									          <td class="checkbox">-->
<!--										          <label>-->
<!--											          --><?php //if (isset($user_groups_fields[$user_group['user_group_id']]) && in_array($field_list_k, $user_groups_fields[$user_group['user_group_id']])) { ?>
<!--												          <input type="checkbox" name="user_groups_fields[--><?//= $user_group['user_group_id']; ?><!--][]"-->
<!--												                 value="--><?php //echo $field_list_k; ?><!--"-->
<!--												                 checked="checked"/>-->
<!--												          --><?php //echo $field_list_v; ?>
<!--											          --><?php //} else { ?>
<!--												          <input type="checkbox" name="user_groups_fields[--><?//= $user_group['user_group_id']; ?><!--][]"-->
<!--												                 value="--><?php //echo $field_list_k; ?><!--"/>-->
<!--												          --><?php //echo $field_list_v; ?>
...
<!--	          </div>-->
  ...
  <?php if ($ckeditor) { ?>
    <?php foreach ($languages as $language) { ?>
        ...
        ckeditorInit('input-additional-description<?php echo $language['language_id']; ?>', getURLVar('token'));
    <?php } ?>
  <?php } ?>
  //--></script>
  <script type="text/javascript"><!--
