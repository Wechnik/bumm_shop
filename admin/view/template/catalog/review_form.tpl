      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-reply-to-review">Ответ на отзыв</label>
            <div class="col-sm-10">
              <textarea name="reply_to_review" cols="60" rows="8" placeholder="Ответ на отзыв" id="input-reply-to-review" class="form-control summernote"><?php echo $reply_to_review; ?></textarea>
            </div>
          </div>
          <div class="form-group required">
