...
<script type="text/javascript"><!--
  <?php if ($ckeditor) { ?>
    <?php foreach ($languages as $language) { ?>
      ckeditorInit('input-sbrf_online_bank<?php echo $language['language_id']; ?>', getURLVar('token'));
      ckeditorInit('input-sbrf_online_page_success<?php echo $language['language_id']; ?>', getURLVar('token'));
    <?php } ?>
  <?php } ?>
//--></script>
<?php echo $footer; ?>