          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-filter-metatag_start">Метатег фильтра начало</label>
                    <div class="col-sm-4">
                        <input type="text" name="config_filter_metatag_start"
                               value="<?php echo isset($config_filter_metatag_start) ? $config_filter_metatag_start : ''; ?>"
                               placeholder="Метатег фильтра начало" id="input-filter-metatag_start" class="form-control" />

                    </div>
                    <label class="col-sm-2 control-label" for="input-filter-metatag_end">Метатег фильтра окончание</label>
                    <div class="col-sm-4">
                        <input type="text" name="config_filter_metatag_end"
                               value="<?php echo isset($config_filter_metatag_end) ? $config_filter_metatag_end : ''; ?>"
                               placeholder="Метатег фильтра окончание" id="input-filter-metatag_end" class="form-control" />
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                  ...
                  <label class="col-sm-2 control-label" for="input-coordinates">Адрес 1</label>
                  <div class="col-sm-4">
                      <input type="text" name="config_coordinates" value="<?php echo $config_coordinates; ?>" placeholder="Адрес 1" id="input-coordinates" class="form-control" />
                  </div>

                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?> 1</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                  ...
                  <label class="col-sm-2 control-label" for="input-coordinates2">Адрес 2</label>
                  <div class="col-sm-4">
                      <input type="text" name="config_coordinates2" value="<?php echo $config_coordinates2; ?>" placeholder="Адрес 2" id="input-coordinates2" class="form-control" />
                  </div>

                <label class="col-sm-2 control-label" for="input-telephone2"><?php echo $entry_telephone; ?> 2</label>
                <div class="col-sm-4">
            ...
            <div class="tab-pane" id="tab-server">
              ...
              <fieldset>
                <legend>Аналитика</legend>
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-ga-analytics"><span data-toggle="tooltip" title="Google аналитика">Google аналитика</span></label>
                      <div class="col-sm-10">
                          <textarea name="config_ga_analytics" rows="5" placeholder="Google аналитика" id="input-ga-analytics" class="form-control"><?php echo $config_ga_analytics; ?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-ya-metric"><span data-toggle="tooltip" title="Яндекс метрика">Яндекс метрика</span></label>
                      <div class="col-sm-10">
                          <textarea name="config_ya_metric" rows="5" placeholder="Яндекс метрика" id="input-ya-metric" class="form-control"><?php echo $config_ya_metric; ?></textarea>
                      </div>
                  </div>
              </fieldset>
            </div>
