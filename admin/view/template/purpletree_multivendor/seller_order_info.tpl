...
<div id="content">
						...
						<?php foreach ($totals as $total) { ?>
							<tr>
								...
								<?php if ($total['sub_title'] == "Refunded") { ?>
									<td colspan="4" class="text-right"><?php echo $total['title']; ?></td>		 
									<td class="text-right"><?php echo $total['text']; ?> <button id ="refund_button"  type="button" return_code ="<?php echo $total['final_code']; ?>" return_value ="<?php echo $total['amount']; ?>" refund_order_id ="<?php echo $order_id; ?>"  return_seller_id = "<?php echo $seller_id; ?>"class="btn  btn-primary btn-xs" ><i class="fa fa-upload"></i></button></td>									
								<?php } ?>
							</tr>
						<?php } ?>
					</tbody>
				...
				<div class="modal-body">
					<form action="<?php echo $refund_acton; ?>" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="hidden" class="form-control" id="return_seller_id" value="" name="return_seller_id">
	...
	<script>  
		$(document).on("click", "#refund_button", function () {
			...
			$('#return_seller_id').val($(this).attr('return_seller_id'));
		});
	</script>
	<script type="text/javascript"><!--
		...
		$('#history').load('index.php?route=purpletree_multivendor/stores/historylist&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>');
		...
		$('#button-history').on('click', function() {
			...
			$.ajax({
				url: '<?php echo $catalog; ?>index.php?route=account/purpletree_multivendor/sellerorder/history&token=<?php echo $token; ?>&store_id=<?php echo $store_id; ?>&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>',
				type: 'post',
				dataType: 'json',
