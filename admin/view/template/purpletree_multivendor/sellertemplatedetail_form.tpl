	...
	<div class="container-fluid">
		...
		<div class="panel panel-default card">
			<div class="panel-heading">
				<h3 class="panel-title card-header"><i class="fa fa-credit-card"></i><?php echo $heading_detailform; ?></h3> 
			</div>
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product">
					...
					<div class="row">
						<div class="col-sm-12 form-group row required">
							...
							<input type="hidden" name="seller_id_filter"
							value="<?php echo $vendor; ?>" class="form-control" />
							<div class="col-sm-9">
...
<script type="text/javascript"><!--
	$('input[name=\'store_name\']').autocomplete({
		...
		'source': function(request, response) {
			...
			$.ajax({
				url: 'index.php?route=purpletree_multivendor/producttemplate/autosellerstore&token=<?php echo $token; ?>&store_name=' +  encodeURIComponent(request),
				dataType: 'json',	
