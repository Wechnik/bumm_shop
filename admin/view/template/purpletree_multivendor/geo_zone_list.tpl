							...
							<thead>
								<tr>
									...
									<td class="text-left"><?php if ($sort == 'name') { ?>
										<a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_seller; ?></a>
										<?php } else { ?>
										<a href="<?php echo $sort_name; ?>"><?php echo $column_seller; ?></a>
									<?php } ?></td> 
									<td class="text-left"><?php if ($sort == 'name') { ?>
									...
									<td class="text-left"><?php if ($sort == 'price') { ?>
										<a href="<?php echo $sort_description; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_price; ?></a>
										<?php } else { ?>
										<a href="<?php echo $sort_description; ?>"><?php echo $column_price; ?></a>
									<?php } ?></td>
								...
								<?php if ($geo_zones) { ?>
									<?php foreach ($geo_zones as $geo_zone) { ?>
										<tr>
											...
											<?php } ?></td>
											<td class="text-left"><?php echo $geo_zone['seller_name']; ?></td>
											<td class="text-left"><?php echo $geo_zone['name']; ?></td>
											<td class="text-left"><?php echo $geo_zone['description']; ?></td>
											<td class="text-left"><?php echo $geo_zone['price']; ?></td>
