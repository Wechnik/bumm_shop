			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-geo-zone" class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-store_name"><?php echo $seller_name; ?></label>
						<div class="col-sm-10">
							<input type="hidden" name="seller_id" value="<?php echo $vendor_id; ?>" class="form-control" />
							<input type="text" name="store_name" value="<?php echo $store_name; ?>" placeholder="<?php echo $seller_name; ?>" id="input-store_name" class="form-control" />
