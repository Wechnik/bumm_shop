		...
		<div class="container">
			<div class="ptsc-subscrip-pagebreak">
					...
					<tbody>
						<tr>
							...
							<td><address>
								...
								<?php echo $sellerdetails['store_address']; ?>
								<?php echo $sellerdetails['store_city']; ?>
							</address>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							<td class="text-right"><b><?php echo $column_id; ?></td>
						...
						<tbody>
							<?php if (!empty($commissionn_history)) { ?>
								<?php foreach ($commissionn_history as $commission_hist) { ?>
									<tr>
