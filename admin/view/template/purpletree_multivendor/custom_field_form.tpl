    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
                      <fieldset>
              <legend><?php echo $text_custom_field; ?></legend>
		  ...
		  <input type="hidden" name="location" id="input-location" value="account"/>
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-step_location"><?php echo $entry_location; ?></label>
            <div class="col-sm-10">
              <select name="step_location" id="input-step_location" class="form-control">
                <?php if ($step == 'one') { ?>
					<option value="one" selected="selected"><?php echo $entry_text_one; ?></option>
                <?php } else { ?>
					<option value="one"><?php echo $entry_text_one; ?></option>
                <?php } ?>
                <?php if ($step == 'two') { ?>
					<option value="two" selected="selected"><?php echo $entry_text_two; ?></option>
              <?php } else { ?>
				<option value="two"><?php echo $entry_text_two; ?></option>
				<?php } ?>
                <?php if ($step == 'three') { ?>
					<option value="three" selected="selected"><?php echo $entry_text_three; ?></option>
                <?php } else { ?>
					<option value="three"><?php echo $entry_text_three; ?></option>
				<?php } ?>
              </select>
            </div>
          </div>
          ...
          <div id="custom-field-value">
            <fieldset>
              ...
              <tr id="custom-field-value-row<?php echo $custom_field_value_row; ?>">
                <td class="text-left ptsc-customfield-formlwid"><input type="hidden" name="custom_field_value[<?php echo $custom_field_value_row; ?>][custom_field_value_id]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" />
...
function addCustomFieldValue() {
    ...
    html += '  <td class="text-left ptsc-customfield-formlwid"><input type="hidden" name="custom_field_value[' + custom_field_value_row + '][custom_field_value_id]" value="" />';
	<?php foreach ($languages as $language) { ?>
