...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                                <input type="text" name="diski_vilet" value="<?php echo $diski_vilet; ?>" placeholder="<?php echo $entry_group; ?>" class="form-control" />
                        </div>
                    </div>
         ...
         <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mark">Ширина</label>
                <div class="col-sm-10">
                    <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                        <table class="table table-striped">
                            <?php foreach ($diskivilets as $diskivilet) { ?>
                                <tr>
                                    <td class="checkbox">
                                        <label>
                                            <?php if (in_array($diskivilet['id'], $diski_to_vilet)) { ?>
                                                <input type="checkbox" name="width_to_vilet[]" value="<?php echo $diskivilet['id']; ?>" checked="checked" />
                                                <?php echo $diskivilet['diski_vilet']; ?>
                                            <?php } else { ?>
                                                <input type="checkbox" name="width_to_vilet[]" value="<?php echo $diskivilet['id']; ?>" />
                                                <?php echo $diskivilet['diski_vilet']; ?>
                                            <?php } ?>
                                        </label>
                                    </td>
