            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                                <input type="text" name="diski_diametr" value="<?php echo $diski_diametr; ?>" placeholder="<?php echo $entry_group; ?>" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mark">Сверловка</label>
                <div class="col-sm-10">
                    <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                        <table class="table table-striped">
                            <?php foreach ($diskiotvs as $diskiotv) { ?>
                                <tr>
                                    <td class="checkbox">
                                        <label>
                                            <?php if (in_array($diskiotv['id'], $otv_diametr)) { ?>
                                                <input type="checkbox" name="otv_to_diametr[]" value="<?php echo $diskiotv['id']; ?>" checked="checked" />
                                                <?php echo $diskiotv['diski_otv']; ?>
                                            <?php } else { ?>
                                                <input type="checkbox" name="otv_to_diametr[]" value="<?php echo $diskiotv['id']; ?>" />
                                                <?php echo $diskiotv['diski_otv']; ?>
                                            <?php } ?>
                                        </label>
                                    </td>
