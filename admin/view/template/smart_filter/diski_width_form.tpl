            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                                <input type="text" name="diski_width" value="<?php echo $diski_width; ?>" placeholder="<?php echo $entry_group; ?>" class="form-control" />
                        </div>
                    </div>
                ...
                <div class="col-sm-10">
                    <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                        <table class="table table-striped">
                            <?php foreach ($diskiwidths as $diskiwidth) { ?>
                                <tr>
                                    <td class="checkbox">
                                        <label>
                                            <?php if (in_array($diskiwidth['id'], $diski_to_width)) { ?>
                                                <input type="checkbox" name="diametr_to_width[]" value="<?php echo $diskiwidth['id']; ?>" checked="checked" />
                                                <?php echo $diskiwidth['diski_width']; ?>
                                            <?php } else { ?>
                                                <input type="checkbox" name="diametr_to_width[]" value="<?php echo $diskiwidth['id']; ?>" />
                                                <?php echo $diskiwidth['diski_width']; ?>
                                            <?php } ?>
                                        </label>
                                    </td>
