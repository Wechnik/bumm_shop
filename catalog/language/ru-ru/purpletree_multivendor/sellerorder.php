...
$_['module_purpletree_multivendor_commission_status_warning']			 = "Предупреждение: расчеты могут быть неверными. Обратитесь к администратору, чтобы установить статус расчета комиссии с помощью параметров многопользовательского режима Multivendor!";