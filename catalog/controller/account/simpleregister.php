...
class ControllerAccountSimpleRegister extends SimpleController {
    ...
    public function index($args = null) {
        ...
        if (!$this->simpleregister->isAjaxRequest() && !$this->_templateData['popup'] && !$this->_templateData['as_module']) {
            ...
            $this->document->addStyle('catalog/view/javascript/c6v/typeahead/typeahead.css');
            $this->document->addScript('catalog/view/javascript/c6v/typeahead/typeahead.bundle.min.js');
            $this->document->addScript('catalog/view/javascript/c6v/c6v.js');
