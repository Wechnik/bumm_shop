<?php
class ControllerAccountPurpletreeMultivendorSellerblogpost extends Controller {
		...
		public function add(){
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('account/purpletree_multivendor/sellerblogpost', '', true));
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST')&& $this->validateForm())  {
				...
				$this->model_purpletree_multivendor_sellerblogpost->addPost($this->request->post,$seller_id);
		...
		protected function getList() {
			...
			'href' => $this->url->link('account/purpletree_multivendor/sellerblogpost', $url, true)
			
			);	
			
			$data['add'] = $this->url->link('account/purpletree_multivendor/sellerblogpost/add', $url, true);
			
			$data['copy'] = $this->url->link('account/purpletree_multivendor/sellerblogpost/copy', $url, true);
			
			$data['delete'] = $this->url->link('account/purpletree_multivendor/sellerblogpost/delete', $url, true);
			...
			$post_total = $this->model_purpletree_multivendor_sellerblogpost->getTotalBlogs($filter_data,$seller_id);
			
			$results = $this->model_purpletree_multivendor_sellerblogpost->getBlogs($filter_data,$seller_id);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('account/purpletree_multivendor/sellerblogpost/edit',  '&blog_post_id=' . $result['blog_post_id'] . $url, true)
			...
			$data['sort_title'] = $this->url->link('account/purpletree_multivendor/sellerblogpost', '&sort=bp.title' . $url, true);
			
			$data['sort_status'] = $this->url->link('account/purpletree_multivendor/sellerblogpost', '&sort=p.status' . $url, true);
			
			$data['sort_order'] = $this->url->link('account/purpletree_multivendor/sellerblogpost', '&sort=p.sort_order' . $url, true);
			...
			$pagination->url = $this->url->link('account/purpletree_multivendor/sellerblogpost', $url . '&page={page}', true);
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['blog_post_id'])) {
				...
				$data['action'] = $this->url->link('account/purpletree_multivendor/sellerblogpost/add', $url, true);
				
				} else {
				
				$data['action'] = $this->url->link('account/purpletree_multivendor/sellerblogpost/edit', '&blog_post_id=' . $this->request->get['blog_post_id'] . $url, true);
				
			}
			
			$data['cancel'] = $this->url->link('account/purpletree_multivendor/sellerblogpost' . $url, true);
		...
		protected function validateForm() {
			//echo"<pre>";print_r($this->request->post['blog_description']);die;
