<?php
class ControllerAccountPurpletreeMultivendorCommonColumnLeft extends Controller {
	public function index() {
		$this->load->language('extension/module/purpletree_sellerpanel');  
		$this->load->language('purpletree_multivendor/header');
		$this->load->language('purpletree_multivendor/common/column_left');
			...
			$data['seller'] = $seller;
			$data['becomeseller'] = $this->url->link('account/purpletree_multivendor/sellerregister', '', true);
			//Start dashboard icons section//
            
            
			$dashboard_menu_icons=$this->config->get('purpletree_multivendor_icons_status');
			...
			$stores=array();
				...
				$data['purpletree_multivendor_status'] = $this->config->get('purpletree_multivendor_status');
				//$data['purpletree_multivendor_become_seller'] = $this->config->get('purpletree_multivendor_become_seller');
				...
				if($data['purpletree_multivendor_seller_product_template'] == 1){
					...
					$data['sellerenquiries'] = $this->url->link('account/purpletree_multivendor/sellerenquiries', '', true);
					...
					///Attribute///
					$data['attribute_link'] = $this->url->link('account/purpletree_multivendor/sellerattribute', '', true);
					$data['attribute_groups_link'] = $this->url->link('account/purpletree_multivendor/sellerattributegroups', '', true);
					$data['options_link'] = $this->url->link('account/purpletree_multivendor/selleroptions', '', true);
					///BLOG///
					...
					if($this->config->get('purpletree_multivendor_hide_user_menu')){
