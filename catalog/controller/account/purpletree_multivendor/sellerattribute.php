<?php
class ControllerAccountPurpletreeMultivendorSellerattribute extends Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_purpletree_multivendor_sellerattribute->addAttribute($this->customer->getId(),$this->request->post);
				...
				$this->response->redirect($this->url->link('account/purpletree_multivendor/sellerattribute', '', true));
			}
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_purpletree_multivendor_sellerattribute->editSellerAttribute($this->request->post);
		...
		public function delete() {
			...
			if (isset($this->request->post['selected'])) {
				foreach ($this->request->post['selected'] as $attribute_id) {
					$this->model_purpletree_multivendor_sellerattribute->deleteSellerAttribute($attribute_id);
				}
		...
		protected function getList() {
			...
			'href' => $this->url->link('account/purpletree_multivendor/sellerattribute',  $url, true)
			);
			$data['add'] = $this->url->link('account/purpletree_multivendor/sellerattribute/add', '',true);
			$data['delete'] = $this->url->link('account/purpletree_multivendor/sellerattribute/delete', '',true);
			...
			$atrribute_total = $this->model_purpletree_multivendor_sellerattribute->getTotalAttributes($this->customer->getId());
			
			$results = $this->model_purpletree_multivendor_sellerattribute->getSellerAtrributes($this->customer->getId(),$filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('account/purpletree_multivendor/sellerattribute/edit', '&attribute_id=' . $result['id'].$url, true)
				);
			}
			...
			$data['sort_name'] = $this->url->link('account/purpletree_multivendor/sellerattribute' , $url, true);
			$data['sort_code'] = $this->url->link('account/purpletree_multivendor/sellerattribute',  '&sort=code' . $url, true);
			$data['sort_discount'] = $this->url->link('account/purpletree_multivendor/sellerattribute', '&sort=discount' . $url, true);
			$data['sort_date_start'] = $this->url->link('account/purpletree_multivendor/sellerattribute', '&sort=date_start' . $url, true);
			$data['sort_date_end'] = $this->url->link('account/purpletree_multivendor/sellerattribute', '&sort=date_end' . $url, true);
			$data['sort_status'] = $this->url->link('account/purpletree_multivendor/sellerattribute', '&sort=status' . $url, true);
			...
			$pagination->url = $this->url->link('account/purpletree_multivendor/sellerattribute', '' . $url . '&page={page}', true);
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['attribute_id'])) {
				$data['action'] = $this->url->link('account/purpletree_multivendor/sellerattribute/add', '',true);
				} else {
				$data['action'] = $this->url->link('account/purpletree_multivendor/sellerattribute/edit','&attribute_id=' . $this->request->get['attribute_id'] , true);
			}
			$data['cancel'] = $this->url->link('account/purpletree_multivendor/sellerattribute','', true);
			...
			$data['attribute_groups'] = $this->model_purpletree_multivendor_sellerattribute->getSellerAttributeGroups($stringgattr);
			
			$data['languages'] = $this->model_localisation_language->getLanguages();
			
			if (isset($this->request->get['attribute_id']) && (!$this->request->server['REQUEST_METHOD'] != 'POST')) {
				$attribute_info = $this->model_purpletree_multivendor_sellerattribute->getSellerAttribute($this->request->get['attribute_id']);
			}
			...
			if (isset($this->request->post['attribute_description'])) {
				...
				$data['attribute_description'] = $this->model_purpletree_multivendor_sellerattribute->getSellerAttributeDescriptions($this->request->get['attribute_id']);
				} else {
		...
		public function history() {
			...
			$results = $this->model_purpletree_multivendor_sellerattribute->getCouponHistories($this->request->get['attribute_id'], ($page - 1) * 10, 10);
			...
			$history_total = $this->model_purpletree_multivendor_sellerattribute->getTotalCouponHistories($this->request->get['attribute_id'],$this->customer->getId());
			$url ='';
			$pagination = new Pagination();
			$pagination->total = $history_total;
			$pagination->page = $page;
			$pagination->limit = 10;
			$pagination->url = $this->url->link('account/purpletree_multivendor/sellerattribute/history', $url . '&page={page}', true);
