<?php
class ControllerAccountPurpletreeMultivendorSellertemplateproduct extends Controller{
		...
		public function index(){
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('account/purpletree_multivendor/sellertemplateproduct', '', true);
			...
			$this->load->model('purpletree_multivendor/sellertemplateproduct');
		...
		public function edit() {
			...
			if(!$this->customer->validateSeller()) {
				$this->load->language('purpletree_multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');			
				$this->response->redirect($this->url->link('account/purpletree_multivendor/sellertemplateproduct', '', true));
			}
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
				...
				if($this->validateForm()) {
					...
					if($this->request->get['id'] != ''){
						$this->model_purpletree_multivendor_sellertemplateproduct->editProductTemplate($this->request->get['id'],$this->request->post);
						}else{
						
						$this->model_purpletree_multivendor_sellertemplateproduct->addProductTemplate($this->request->get['template_id'],$this->request->post);
					}
					$temp_product_id = $this->model_purpletree_multivendor_sellertemplateproduct->getTemplateProductId($this->request->get['template_id']);
					$minprice = $this->model_purpletree_multivendor_sellertemplateproduct->getMinPrice($temp_product_id);
					
					
					if(!empty($minprice)){
						$this->model_purpletree_multivendor_sellertemplateproduct->updatePrice($minprice);
					}
					else {
						$this->model_purpletree_multivendor_sellertemplateproduct->updateZero($temp_product_id);
					}
		...
		protected function getForm() {
			...
			$data['action'] = $this->url->link('account/purpletree_multivendor/sellertemplateproduct/edit','&id=' . $this->request->get['id'].'&template_id=' . $this->request->get["template_id"] , true);		
			$seller_id = $this->customer->getId();
			$data['cancel'] = $this->url->link('account/purpletree_multivendor/sellertemplateproduct','', true);
			
			if (isset($this->request->get['id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
				$product_info = $this->model_purpletree_multivendor_sellertemplateproduct->getProduct($this->request->get['id'],$seller_id);
				;
			}
			...
			if(isset($product_info['template_id'])){
				$seller_prices = $this->model_purpletree_multivendor_sellertemplateproduct->getTemplatePrice($product_info['template_id']);	
				}else{
				$seller_prices = $this->model_purpletree_multivendor_sellertemplateproduct->getTemplatePrice($this->request->get['template_id']);
			}
      		if(!empty($seller_prices)) {
				foreach($seller_prices as $seller_price){
					...
					$rating = $this->model_purpletree_multivendor_sellertemplateproduct->getStoreRating($seller_price['seller_id']);
			...
			if (!empty($product_info)) {
				...
				if($this->request->get['id'] == ''){
					$temp_info = $this->model_purpletree_multivendor_sellertemplateproduct->getTemplateInfo($this->request->get['template_id']);
			...
			$data['back'] = $this->url->link('account/purpletree_multivendor/sellertemplateproduct', '', true);
		...
		public function delete() {
			...
			if (isset($this->request->get['id'])) {
				...
				$this->model_purpletree_multivendor_sellertemplateproduct->deleteProduct($this->request->get['id']);
				$temp_product_id = $this->model_purpletree_multivendor_sellertemplateproduct->getTemplateProductId($this->request->get['template_id']);
			    $minprice = $this->model_purpletree_multivendor_sellertemplateproduct->getMinPrice($temp_product_id);
		...
		protected function getList(){
			...
			$product_total = $this->model_purpletree_multivendor_sellertemplateproduct->getTotalSellerProducts($filter_data);
			$seller_id = $this->customer->getId();	
			$results = $this->model_purpletree_multivendor_sellertemplateproduct->getSellerProducts($filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('account/purpletree_multivendor/sellertemplateproduct/edit','id=' . $result["seller_template_id"].'&template_id=' . $result["id"].$url, true),
				'delete'       => $this->url->link('account/purpletree_multivendor/sellertemplateproduct/delete','id=' . $result['seller_template_id'].'&template_id=' . $result["id"].$url, true)
				);
			}
			...
			$pagination->url = $this->url->link('account/purpletree_multivendor/sellertemplateproduct', $url . '&page={page}', true);
		...
		public function autocomplete() {
			...
			if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
				...
				$results = $this->model_purpletree_multivendor_sellertemplateproduct->getProducts($filter_data);
				foreach ($results as $result) {
					$json[] = array(
					'product_id' => $result['product_id'],
