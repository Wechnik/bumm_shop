<?php
class ControllerAccountPurpletreeMultivendorSellerlogin extends Controller {
		private $error = array();
		...
		public function index() {		
			...
			'href' => $this->url->link('account/purpletree_multivendor/sellerlogin', '', true)
			);
			...
			$data['action'] = $this->url->link('account/purpletree_multivendor/sellerlogin', '', true);
			$data['sellerregister'] = $this->url->link('account/purpletree_multivendor/sellerregister', '', true);
		...
		protected function validate() {;
			...
			if(!empty($customer_info['customer_id'])){
				...
				$store_detail = $this->model_purpletree_multivendor_vendor->isSeller($customer_info['customer_id']);	
