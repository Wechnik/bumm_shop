<?php
class ControllerAccountPurpletreeMultivendorApiSellerorder extends Controller{
		private $error = array();
		...
		public function index(){
			...
			$json['data']['order_statuses'] = $this->model_localisation_order_status->getOrderStatuses();
		...
		public function seller_order_info(){
			...
			$seller_id = $this->customer->getId();
			$json['data']['manage_order'] = $this->config->get('purpletree_multivendor_seller_manage_order');
			...
			$json['data']['purpletree_multivendor_commission_status'] = $orderstatus;
			if ($order_info) { 
				$this->load->language('purpletree_multivendor/sellerorder');
				...
				$json['data']['payment_address'] = str_replace(array("\r\n", "\r", "\n"), '<br />', preg_replace(array("/\s\s+/", "/\r\r+/", "/\n\n+/"), '<br />', trim(str_replace($find, $replace, $format))));
				...
				$json['data']['shipping_address'] = str_replace(array("\r\n", "\r", "\n"), '<br />', preg_replace(array("/\s\s+/", "/\r\r+/", "/\n\n+/"), '<br />', trim(str_replace($find, $replace, $format))));
				...
				$json['data']['reward_total'] = $this->model_purpletree_multivendor_sellerorder->getTotalCustomerRewardsByOrderId($this->request->get['order_id']);
		...
		public function history() {
			...
			if ($order_info) {
				$this->purpletree_multivendor->addOrderHistory($order_id,$seller_id, $this->request->post['order_status_id'], $this->request->post['comment'], $this->request->post['notify'], $this->request->post['override']);
				$json['status'] = 'success';
		...
		public function historylist() {
			...
			$results = $this->model_purpletree_multivendor_sellerorder->getOrderHistories($order_id,$seller_id, ($page - 1) * 10, 10);
			...
			$history_total = $this->model_purpletree_multivendor_sellerorder->getTotalOrderHistories($order_id,$seller_id);
