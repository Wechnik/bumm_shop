<?php
class ControllerAccountPurpletreeMultivendorApiDashboard extends Controller {
		private $error = array();
		...
		public function index(){
			...
			$json['data']['order_total'] = $this->model_purpletree_multivendor_dashboard->getTotalSellerOrders($filter_data);
			...
			$json['data']['total_sale'] =$this->currency->format($this->model_purpletree_multivendor_dashboard->getTotalsale($filter_data), $currency_detail['code'], $currency_detail['value']);
