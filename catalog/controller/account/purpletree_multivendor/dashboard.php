<?php
class ControllerAccountPurpletreeMultivendorDashboard extends Controller {
		private $error = array();
		...
		public function index(){
			...
			'href' => $this->url->link('account/purpletree_multivendor/dashboard', $url, true)
			);
			$data['my_orders']=$this->url->link('account/purpletree_multivendor/sellerorder', $url, true);
			
			$data['my_commission']=$this->url->link('account/purpletree_multivendor/sellercommission', $url, true);
			
			$data['my_payments']=$this->url->link('account/purpletree_multivendor/sellerpayment', $url, true);
			$data['my_sales']=$this->url->link('account/purpletree_multivendor/sellerorder', $url, true);
			...
			$total_commission1 = $this->model_purpletree_multivendor_dashboard->getTotalSellerOrderscommission($this->customer->getId(),$orderstatus);
			...
			$data['order_total'] = $this->model_purpletree_multivendor_dashboard->getTotalSellerOrders($filter_data);
			
			$results = $this->model_purpletree_multivendor_dashboard->getSellerOrders($filter_data);
			$seller_commissions = $this->model_purpletree_multivendor_dashboard->getCommissions($filter_data);
			...
			$seller_payments = $this->model_purpletree_multivendor_dashboard->getPayments($filter_data);
			$stotal_payments = $this->model_purpletree_multivendor_dashboard->getTotalPayments($filter_data);
			$data['total_payments'] = $this->currency->format($stotal_payments, $currency_detail['code'], $currency_detail['value']);
			$pending_payments = $this->model_purpletree_multivendor_dashboard->pendingPayments($filter_data1);
			$totalpaymentss = 0;
			$orderstatus = 0;
			if(null !== $this->config->get('purpletree_multivendor_commission_status')) {
				$orderstatus = $this->config->get('purpletree_multivendor_commission_status');
			...
			$data['total_sale'] =$this->currency->format($this->model_purpletree_multivendor_dashboard->getTotalsale($filter_data), $currency_detail['code'], $currency_detail['value']);
			...
			foreach ($results as $result) {
				$total ='';
				$product_totals  = $this->model_purpletree_multivendor_dashboard->getSellerOrdersTotal($seller_id,$result['order_id']);
				...
				$product_commission  = $this->model_purpletree_multivendor_dashboard->getSellerOrdersCommissionTotal($result['order_id'],$seller_id);
