<?php
class ControllerAccountPurpletreeMultivendorSellerblogcomment extends Controller {
		private $error = array();
		
		public function index() {
			if (!$this->customer->isLogged()) {
				
				$this->session->data['redirect'] = $this->url->link('account/purpletree_multivendor/sellerblogcomment', '', true);
		...
		$store_detail = $this->customer->isSeller();
			...
			if(!$this->customer->validateSeller()) {
				...
				$this->response->redirect($this->url->link('account/purpletree_multivendor/sellerblogcomment', '', true));
			}
			$this->load->language('purpletree_multivendor/sellerblogcomment');
		...
		public function delete() {
			...
			if (isset($this->request->post['selected']) && $this->validateDelete()) {
				...
				$this->response->redirect($this->url->link('account/purpletree_multivendor/sellerblogcomment',$url, true));
			}
		...
		$store_detail = $this->customer->isSeller();
			...
			'href' => $this->url->link('account/purpletree_multivendor/sellerblogcomment', $url, true)
			);		
			
			
			$data['delete'] = $this->url->link('account/purpletree_multivendor/sellerblogcomment/delete',$url, true);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('account/purpletree_multivendor/sellerblogcomment/edit','&comment_id=' . $result['blog_comment_id'] . $url, true)
				);
			}
			...
			$pagination->url = $this->url->link('account/purpletree_multivendor/sellerblogcomment',$url . '&page={page}', true);
		...
		$store_detail = $this->customer->isSeller();
			...
			if (!isset($this->request->get['comment_id'])) {
				$data['action'] = $this->url->link('account/purpletree_multivendor/sellerblogcomment/add',$url, true);
				} else {
				$data['action'] = $this->url->link('account/purpletree_multivendor/sellerblogcomment/edit','&comment_id=' . $this->request->get['comment_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('account/purpletree_multivendor/sellerblogcomment',$url, true);
