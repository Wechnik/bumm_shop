<?php
class ControllerAccountPurpletreeMultivendorCommissioninvoicenotify extends Controller {
		
		public function index() {
			$this->load->model('purpletree_multivendor/commissioninvoicenotify');
			...
			if (strcmp ($res, "VERIFIED") == 0) {
				...
				try {
					...
					$this->model_purpletree_multivendor_commissioninvoicenotify->addPaypalPaymentHistory($dataarraypaypal);
					} catch(Exception $e){ 
