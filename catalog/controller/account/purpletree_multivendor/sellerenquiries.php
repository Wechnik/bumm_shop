<?php
class ControllerAccountPurpletreeMultivendorSellerenquiries extends Controller {
		private $error = array();
		...
		public function index(){
			...
			$this->model_purpletree_multivendor_sellerenquiries->updateSeenMessage($data['seller_id']);
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validatemessage()) {
				
				$this->model_purpletree_multivendor_sellerenquiries->sendSellerMessage($this->request->post);
				
				$seller_info = $this->model_purpletree_multivendor_sellerenquiries->getSellername($data['seller_id']);
				...
				$this->response->redirect($this->url->link('account/purpletree_multivendor/sellerenquiries','',true));
			}
			///Help code///	
			...
			'href' => $this->url->link('account/purpletree_multivendor/sellerenquiries', '', true)
			);
			...
			$data['messages']=$this->model_purpletree_multivendor_sellerenquiries->getSellerMessage($filter_data);
			$order_total = $this->model_purpletree_multivendor_sellerenquiries->getTotalSellerMessage($filter_data);
			
			$pagination = new Pagination();
			$pagination->total = $order_total;
			$pagination->page = $page;
			$pagination->limit = $this->config->get('config_limit_admin');
			$pagination->url = $this->url->link('account/purpletree_multivendor/sellerenquiries', $url . '&page={page}', true);
