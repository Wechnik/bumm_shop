<?php
class ControllerAccountPurpletreeMultivendorProductReturns extends Controller {
		private $error = array();
		public function index() {
			...
			$this->load->model('purpletree_multivendor/product_returns');
		...
		$store_detail = $this->customer->isSeller();
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_purpletree_multivendor_product_returns->editReturn($this->request->get['return_id'], $this->request->post);
				...
				$this->response->redirect($this->url->link('account/purpletree_multivendor/product_returns',$url, true));
			}
		...
		protected function getList() {
		   $store_detail = $this->customer->isSeller();
			...
			'href' => $this->url->link('account/purpletree_multivendor/product_returns', $url, true)
			);
			...
			$data['add'] = $this->url->link('account/purpletree_multivendor/product_returns/add', $url, true);
			$data['delete'] = $this->url->link('account/purpletree_multivendor/product_returns/delete', $url, true);
			...
			$return_total = $this->model_purpletree_multivendor_product_returns->getTotalReturns($filter_data);
			
			$results = $this->model_purpletree_multivendor_product_returns->getReturns($filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'          => $this->url->link('account/purpletree_multivendor/product_returns/edit','&return_id=' . $result['return_id'] . $url, true)
				);
			}
			...
			$data['sort_return_id'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_order_id'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_customer'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_product'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_model'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_status'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_date_added'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			$data['sort_date_modified'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			...
			$pagination->url = $this->url->link('account/purpletree_multivendor/product_returns', $url . '&page={page}', true);
			...
			$data['return_statuses'] = $this->model_purpletree_multivendor_product_returns->getReturnStatuses();
		...
		$store_detail = $this->customer->isSeller();
			...
			$data['action'] = $this->url->link('account/purpletree_multivendor/product_returns/edit','&return_id=' . $this->request->get['return_id'] . $url, true);
			
			
			$data['cancel'] = $this->url->link('account/purpletree_multivendor/product_returns', $url, true);
			
			if (isset($this->request->get['return_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
				$return_info = $this->model_purpletree_multivendor_product_returns->getReturn($this->request->get['return_id']);
			}
			...
			$data['return_reasons'] = $this->model_purpletree_multivendor_product_returns->getReturnReasons();
			...
			$data['return_actions'] = $this->model_purpletree_multivendor_product_returns->getReturnActions();
		...
		public function history() {
			...
			$results = $this->model_purpletree_multivendor_product_returns->getReturnHistories($this->request->get['return_id'], ($page - 1) * 10, 10);
			...
			$data['text_no_results'] = $this->language->get('text_no_results');
			$data['text_history_add'] = $this->language->get('text_history_add');
			$history_total = $this->model_purpletree_multivendor_product_returns->getTotalReturnHistories($this->request->get['return_id']);
			$pagination = new Pagination();
			$pagination->total = $history_total;
			$pagination->page = $page;
			$pagination->limit = 10;
			$pagination->url = $this->url->link('account/purpletree_multivendor/product_returns/history', '&return_id=' . $this->request->get['return_id'] . '&page={page}', true);
			$data['pagination'] = $pagination->render();
		...
		public function addHistory() {
			...
			$json = array();		
			$this->load->model('purpletree_multivendor/product_returns');
			$this->model_purpletree_multivendor_product_returns->addReturnHistory($this->request->get['return_id'], $this->request->post['return_status_id'], $this->request->post['comment'], $this->request->post['notify']);
		...
		public function autocomplete() {
			...
			if (isset($this->request->get['filter_name'])) {
				...
				$results = $this->model_purpletree_multivendor_product_returns->getProducts($filter_data);
