...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			if ($category_info['meta_title'] && !empty($category_info['meta_title'])) {
			...
			if ($category_info['meta_h1'] && !empty($category_info['meta_h1'])) {
            ...
            if ($category_info['description']) {
                if (preg_match("/#additional-separator#/i", $category_info['description'])) {
                    $description = explode("#additional-separator#", $category_info['description']);
                    $data['description'] = html_entity_decode($description[0], ENT_QUOTES, 'UTF-8');
                    $data['additional_description'] = html_entity_decode($description[1], ENT_QUOTES, 'UTF-8');
                } else {
            ...
            $data['expand_block'] = mb_strlen($data['description']) > 600 ? true : false;
...
//                        'is_universal' => 1,
			...
			$data['products'] = $this->load->controller('common/product_card', array('products' => $results, 'page' => 'category'));
