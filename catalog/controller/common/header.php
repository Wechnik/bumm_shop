...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $data['config_ya_metric'] =  html_entity_decode($this->config->get('config_ya_metric'), ENT_QUOTES, 'UTF-8');
        $data['config_ga_analytics'] =  html_entity_decode($this->config->get('config_ga_analytics'), ENT_QUOTES, 'UTF-8');
        ...
        $data['coordinates1'] = $this->config->get('config_coordinates');
        $data['coordinates2'] = $this->config->get('config_coordinates2');
		...
		$data['popup_cart'] = $this->load->controller('common/cart/popup_cart');
