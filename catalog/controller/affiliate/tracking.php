...
class ControllerAffiliateTracking extends Controller {
	public function index() {
		...
		$data = $this->load->language('affiliate/tracking');
        ...
        $data['centr_values'] = $this->model_affiliate_affiliate->getCentr();
        $data['back'] = $this->url->link('affiliate/account', '', true);
        $data['categories'] = $this->model_affiliate_affiliate->getAffCategories();
	   /*	$data['heading_title'] = $this->language->get('heading_title');
        ...
        $data['action'] = $this->url->link('affiliate/tracking/edit', '', true);
   ...
   public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
		 //   print_r($this->request->post); exit;
			$this->model_affiliate_affiliate->editCentr($this->request->post);
