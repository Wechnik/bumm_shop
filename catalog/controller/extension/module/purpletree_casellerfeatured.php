		...
		public function index($setting) {
		 ...
		 if ($direction=='rtl'){
			...
			if ($category_info) {
				...
				if ($this->config->get('purpletree_casellerfeatured_limit')) {
				$products = array_slice($productss, 0, (int)$this->config->get('purpletree_casellerfeatured_limit'));
				}else{
				$products = array_slice($productss, 0, 5);
				}
				$image_height = 200;
				$image_width = 200;
				if ($this->config->get('purpletree_casellerfeatured_height')) {
				  $image_height = $this->config->get('purpletree_casellerfeatured_height');
				}
				if ($this->config->get('purpletree_casellerfeatured_width')) {
				  $image_width = $this->config->get('purpletree_casellerfeatured_width');
				}
				/* get active skin */
