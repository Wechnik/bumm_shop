...
class ControllerExtensionModulePurpletreeLatestsellerProducts extends Controller {
		public function index($setting) {
		 ...
		 if ($direction=='rtl'){
			...
			if ($this->config->get('purpletree_latestseller_products_limit')) {
			$products = array_slice($productss,0, (int)$this->config->get('purpletree_latestseller_products_limit'));
			}else{
			$products = array_slice($productss, 0, 5);
			}
			$image_height = 200;
			$image_width = 200;
			if ($this->config->get('purpletree_latestseller_products_height')) {
			  $image_height = $this->config->get('purpletree_latestseller_products_height');
			}
			if ($this->config->get('purpletree_latestseller_products_width')) {
			  $image_width = $this->config->get('purpletree_latestseller_products_width');
			}
			/* get active skin */		    
