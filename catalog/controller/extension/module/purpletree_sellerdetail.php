...
class ControllerExtensionModulePurpletreeSellerdetail extends Controller {
		public function index() { 		
			if($this->config->get('purpletree_multivendor_status') && $this->config->get('purpletree_sellerdetail_status')){			
				...
				{					
					...
					$seller_detail = $this->model_purpletree_multivendor_sellerproduct->getSellername($this->request->get['product_id']);
					$seller_prices = array();
					...
					$store_detail = $this->model_purpletree_multivendor_vendor->getStore($seller_store_id);
					$seller_info_social = $this->model_purpletree_multivendor_vendor->getStoreSocial($seller_store_id);
