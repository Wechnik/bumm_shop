...
<?php if ($categories) { ?>
    ...
    <?php } else { ?>
			...
			<div class="row">
				<ul class="smart-filter-cats row text-center">
					<?php foreach ($categories as $cat_key => $category) { ?>
						<li class="text-center">
							<a href="#" id="<?php echo $category['categories']['cat_tab_name']; ?>"  onclick="return false;">
						...
						<script>
							$("#<?php echo $category['categories']['cat_tab_name']; ?>").click(function() {
								$('html, body').animate({
									scrollTop: parseInt($(".category-name-<?php echo $category['categories']['cat_tab_name']; ?>").offset().top)
								}, 1500);
							});
						</script>
					<?php } ?>
                ...
                <?php foreach ($categories as $cat_key => $category) { ?>
	                    <div class=""
	                         id="<?php echo $category['categories']['cat_tab_name']; ?>">
	                        <?php if ($category['cat_prods']) { ?>
		                            <h4 class="smart-cat-name category-name-<?php echo $category['categories']['cat_tab_name']; ?>">
			                            <?php echo $category['categories']['cat_name']; ?>
		                            </h4>
	                                        ...
	                                        <div class="product-thumb">
	                                            ...
	                                            <div class="bottom flex fl-wrap fl-ai-center">
	                                                <div class="caption">
		                                                ...
		                                                <div class="smart-filter-product-description">
			                                                <a data-hpm-href="1" href="<?php echo $product['href']; ?>" class="clearfix">
	                ...
	                <script>
		                ...
		                var countCatProds = '<?= count($category['cat_prods']);?>';
				              
		                var centerMode = true;
		                
		                if(countCatProds < 4 && slideWidth > 1024) {
			                centerMode = false;
		                } else if(countCatProds < 3 && slideWidth > 600) {
			                centerMode = false;
		                } else if(countCatProds < 2 && slideWidth > 480) {
			                centerMode = false;
		                }
