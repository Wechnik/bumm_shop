							...
							<?php if ($options) { ?>
								<?php foreach ($options as $option) { ?>
									<tr>
										...
										<?php } ?></td>
										<td class="pts-text-left"><?php echo $option['name']; ?></td>
										<td class="pts-text-left"><?php echo $option['sort_order']; ?></td>
										<td class="pts-text-right"><a href="<?php echo $option['edit']; ?> data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
									</tr>
								<?php } ?>
								<?php } else { ?>
								<tr>
