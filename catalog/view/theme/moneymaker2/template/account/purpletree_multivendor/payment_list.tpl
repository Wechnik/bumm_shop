			...
			<?php if ($seller_payments) { ?>
				<div class="pts-table-responsive">
					<table class="pts-table pts-table-bordered pts-table-hover">
						<thead>
							<tr>
								<td class="pts-text-left"><?php echo $text_trnasaction; ?></td>
								<td class="pts-text-left"><?php echo $text_amount; ?></td>
								<td class="pts-text-left"><?php echo $text_payment_mode; ?></td>
								<td class="pts-text-left"><?php echo $text_status; ?></td>
						...
						<tbody>
							<?php foreach ($seller_payments as $seller_payment) { ?>
								<tr>
									<td class="pts-text-left"><?php echo $seller_payment['transaction_id']; ?></td>
									<td class="pts-text-left"><?php echo $seller_payment['amount']; ?></td>
									<td class="pts-text-left"><?php echo $seller_payment['payment_mode']; ?></td>
									<td class="pts-text-left"><?php echo $seller_payment['status']; ?></td>
									<td class="pts-text-left"><?php echo $seller_payment['created_at']; ?></td>
								</tr>
							<?php } ?>
						</tbody>
					</table>
...
<script type="text/javascript"><!--
	$('#pts-button-filter').on('click', function() {
		url = 'index.php?route=account/purpletree_multivendor/sellerpayment';
