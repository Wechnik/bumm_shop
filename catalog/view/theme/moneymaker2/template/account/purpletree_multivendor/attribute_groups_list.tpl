     ...
     <h1><?php echo $heading_title; ?></h1>
	  ...
	  <?php  foreach($breadcrumbs as $breadcrumb): ?>
			  ...
			  <div class="pull-right float-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="pts-btn pts-btn-primary"><i class="fa fa-plus"></i></a>
				<button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="pts-btn pts-btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-attribute').submit() : false;"><i class="fa fa-trash-o fas fa-trash-alt"></i></button>
				<?php if ($helpcheck) { ?>
