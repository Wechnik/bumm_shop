  ...
  <div class="container footer-container">
    <div class="row">
      ...
      <?php if ($informations) { ?>
        <div class="col-sm-3">
          <nav class="navbar" role="navigation">
              <div class="collapsed" data-toggle="collapse" data-target="#information-navbar-collapse">
                  <div class="h5 text-muted hidden-lg hidden-md">
              ...
              <div class="h5 text-muted hidden-sm hidden-xs">
                  <i class="fa fa-fw fa-book"></i>
                  <?php echo $text_information; ?>
              </div>
      ...
      <?php if (!$moneymaker2_footer_customer_hide) { ?>
          <div class="col-sm-3">
              <nav class="navbar" role="navigation">
                  <div class="collapsed" data-toggle="collapse" data-target="#service-navbar-collapse">
                      <div class="h5 text-muted hidden-lg hidden-md">
      ...
      <?php if (!$moneymaker2_footer_extras_hide) { ?>
          <div class="col-sm-3">
              <nav class="navbar" role="navigation">
                  <div class="collapsed" data-toggle="collapse" data-target="#extra-navbar-collapse">
                      <div class="h5 text-muted hidden-lg hidden-md">
                  ...
                  <div class="collapse navbar-collapse" id="extra-navbar-collapse">
                      <ul class="nav list-unstyled">
      ...
      <?php if (!$moneymaker2_footer_account_hide) { ?>
          <div class="col-sm-3">
              <nav class="navbar" role="navigation">
                  <div class="collapsed" data-toggle="collapse" data-target="#user-navbar-collapse">
                  <div class="h5 text-muted hidden-lg hidden-md">
      ...
      <?php if ($moneymaker2_footer_contacts_enabled) { ?>
        <?php if ($moneymaker2_footer_contacts) { ?>
              <div class="col-sm-3">
                  <nav class="navbar" role="navigation">
                      <div class="collapsed">
                      <div class="h5 text-muted hidden-lg hidden-md" data-toggle="collapse" data-target="#<?php echo $moneymaker2_footer_contacts_icon; ?>-navbar-collapse">
                          <i class="fa fa-fw fa-<?php echo $moneymaker2_footer_contacts_icon; ?>"></i>
                          <?php echo $moneymaker2_footer_contacts_title; ?>
                          <i class="fa fa-chevron-up" aria-hidden="true"></i>
                          <i class="fa fa-chevron-down" aria-hidden="true"></i>
                      </div>
                      </div>
                      ...
                      <div class="collapse navbar-collapse" id="<?php echo $moneymaker2_footer_contacts_icon; ?>-navbar-collapse">
                          <ul class="nav list-unstyled">
      ...
      <?php if ($moneymaker2_footer_text1_enabled) { ?>
        <?php if ($moneymaker2_footer_text1) { ?>
              <div class="col-sm-3">
                  <nav class="navbar" role="navigation">
                      <div class="collapsed">
                      <div class="h5 text-muted hidden-lg hidden-md" data-toggle="collapse" data-target="#<?php echo $moneymaker2_footer_text1_icon; ?>-navbar-collapse">
                              <i class="fa fa-fw fa-<?php echo $moneymaker2_footer_text1_icon; ?>"></i>
                              <?php echo $moneymaker2_footer_text1_title; ?>
                          <i class="fa fa-chevron-up" aria-hidden="true"></i>
                          <i class="fa fa-chevron-down" aria-hidden="true"></i>
                          </div>
                      </div>
                      ...
                      <div class="collapse navbar-collapse" id="<?php echo $moneymaker2_footer_text1_icon; ?>-navbar-collapse">
                          <ul class="nav list-unstyled">
        ...
        <ul class="list-unstyled">
          ...
          <li>
            <div class="input-group input-group-sm">
              <input type="text" id="newsletteremail" autocomplete="email" value="<?php echo $moneymaker2_customer_email; ?>" placeholder="<?php echo $text_quickorder_email; ?>" class="form-control">
...
<script type="application/javascript">
    $(document).ready(function() {
        $('.footer-container .navbar > div').on('click', function(){
            var $self = $(this);
            if($('.footer-container .navbar .navbar-collapse').hasClass('in')) {
                $self.parent().find('.fa-arrow-down').css('display', 'block');
                $self.parent().find('.fa-arrow-up').css('display', 'none')
            } else {
                $self.parent().find('.fa-arrow-down').css('display', 'none');
                $self.parent().find('.fa-arrow-up').css('display', 'block')
            }
            if($('.footer-container .navbar .navbar-collapse').hasClass('in')) {
                $self.parent().find('.fa-chevron-down').css('display', 'block');
                $self.parent().find('.fa-chevron-up').css('display', 'none')
            } else {
                $self.parent().find('.fa-chevron-down').css('display', 'none');
                $self.parent().find('.fa-chevron-up').css('display', 'block')
            }
        });

    });
    // $('.footer-container .navbar .in').parent().find('.fa-arrow-down').css({'display': 'none'});
</script>
  ...
  $(document).ready(function() {
    ...
    $('#orderModal').on('show.bs.modal', function (event) {
      ...
      if (mode=="product" || mode=="catalog" || mode=="cart") {
        ...
        <?php if ($moneymaker2_modules_quickorder_hide_email) { ?>
          modal.find('.modal-dialog .form-group.required:first-child').addClass('hidden');
          modal.find('.modal-dialog #quickorderemail').val('<?php echo $moneymaker2_modules_quickorder_recipient; ?>');
        ...
        modal.find('.img-responsive').parent().find('div.hidden').html("<?php echo addslashes($moneymaker2_modules_newsletter_caption); ?>");
        ...
        $.ajax({
          ...
          success: function(json) {
            ...
            if (json['success']) {
              ...
              <?php if ($moneymaker2_modules_callback_goal_google) { ?>
                ga('send', 'event', 'button', 'click', 'callback');
              <?php } ?>
              <?php if ($moneymaker2_modules_callback_goal_yandex) { ?>
                yaCounter<?php echo $moneymaker2_modules_callback_goal_yandex_counter; ?>.reachGoal('callback');
              <?php } ?>
            }
          },
          error: function(xhr, ajaxOptions, thrownError) {
    ...
    if (!mmr2cookies.get('mmr2_popup')) {
      ...
      }, <?php echo $moneymaker2_modules_popup_delay; ?>);
    }
    <?php } ?>
    <?php if ($moneymaker2_header_alert&&$moneymaker2_header_alert_text) { ?>
    if (!mmr2cookies.get('mmr2_alert')) {
      $("header").before( '<div class="header-alert collapse"><div class="pull-right text-primary" data-toggle="collapse" data-target="body > .collapse"><i class="fa fa-close"></i></div><div class="container"><div class="text-center"><?php echo addslashes($moneymaker2_header_alert_text); ?></div></div></div>' );
...
<?php if ($smartsearch) { ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('keyup', '<?php echo $smartsearch_field; ?>', function(e) {
        ...
        $(document).on('focus', '<?php echo $smartsearch_field; ?>', function(e) {
            var smartsearch = $(this).parent().find('.smartsearch');
        ...
        $(document).mouseup(function (e) {
            var container = $('<?php echo $smartsearch_field; ?>');
