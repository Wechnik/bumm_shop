...
<div class="row">
  ...
  <div class="owl-carousel owl-moneymaker2 owl-moneymaker2-products owl-moneymaker2-products-bestseller">
  <?php } ?>
...
<?php if ($moneymaker2_modules_bestseller_carousel) { ?>
<script><!--
  $(".col-sm-3 > div > .owl-moneymaker2-products-bestseller").each(function(){
    $(this).owlCarousel({
  ...
  $(".col-sm-6 > div > .owl-moneymaker2-products-bestseller").each(function(){
    $(this).owlCarousel({
  ...
  $(".col-sm-9 > div > .owl-moneymaker2-products-bestseller").each(function(){
    $(this).owlCarousel({
  ...
  $(".col-sm-12 > div > .owl-moneymaker2-products-bestseller").each(function(){
    $(this).owlCarousel({
