      ...
      <div class="row catalog-sub">
        <div class="col-sm-12">
          <div class="text-center">
            ...
            <?php if ($geocode) { ?><a class="btn btn-sm btn-link" href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=<?php echo $geocode_hl; ?>&t=m&z=15" target="_blank"><?php echo $button_map; ?></a><?php } ?>
