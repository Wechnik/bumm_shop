        ...
        <div class="row catalog-sub">
          <div class="col-sm-12">
            <div class="text-center">
              <?php foreach ($products as $product) { ?><a class="btn btn-sm btn-link" href="<?php echo $product['href']; ?>" data-hpm-href="1"><?php echo $product['name']; ?></a><?php } ?>
            </div>
          </div>
        </div>
        <hr class="catalog-hr">
        <?php if ($moneymaker2_catalog_compare_charts_enabled&&isset($moneymaker2_compare_dataset)&&$moneymaker2_compare_dataset) { ?>
          ...
          <table class="table">
            <tbody>
              <tr>
                ...
                <th class="name text-center"><a href="<?php echo $product['href']; ?>" data-hpm-href="1"<?php if ($product['special']) { ?> class="text-special"<?php } ?>><?php echo $product['name']; ?></a><?php if (isset($product['code'])&&$product['code']) { ?><br /><small class="text-muted"><?php echo $product['code']; ?></small><?php } ?></th>
                <?php } ?>
              </tr>
...
<script><!--
  $(document).ready(function() {
    <?php if ($success) { ?>
      ...
      $('#popupModal').modal();
    <?php } ?>
    <?php if ($products&&$moneymaker2_catalog_compare_charts_enabled&&isset($moneymaker2_compare_dataset)&&$moneymaker2_compare_dataset) { ?>
      <?php foreach ($moneymaker2_compare_dataset as $key => $value) { ?>
