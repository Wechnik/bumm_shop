...
$(document).ready(function() {
    ...
    $('.article-gallery').each(function() {
        $(this).magnificPopup({
            ...
            mainClass: 'mfp-square mfp-effect',
            callbacks: {
                elementParse: function(item) {
                    if(item.el.hasClass('thumbnail-video')){
                        item.type = 'iframe';
                    } else {
                        item.type = 'image';
                    }
    ...
    'remove': function(key) {
        $.ajax({
            ...
            success: function(json) {
                ...
                $('.required-option').closest('.form-group').css('display', 'none');
                $('.option-text-custom').removeClass('active-option-item');
                $('.option-picture').removeClass('active-option-item');
            },
            error: function(xhr, ajaxOptions, thrownError) {
                alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
            }
