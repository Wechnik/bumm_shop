...
class ModelExtensionModuleProgromanFias extends Model {
    ...
    private function getFiasFields() {
        return "f1.offname f1_name, f1.offname_gc f1_name_gc, f1.offname_pc f1_name_pc, f1.shortname f1_shortname, "
            . "f1.fias_id f1_fias_id, f1.level f1_level, f1.postalcode f1_postalcode, "
            . "f2.offname f2_name, f2.offname_gc f2_name_gc, f2.offname_pc f2_name_pc, f2.shortname f2_shortname, "
            . "f2.fias_id f2_fias_id, f2.level f2_level, "
            . "f3.offname f3_name, f3.offname_gc f3_name_gc, f3.offname_pc f3_name_pc, f3.shortname f3_shortname, "
            . "f3.fias_id f3_fias_id, f3.level f3_level, "
            . "f4.offname f4_name, f4.offname_gc f4_name_gc, f4.offname_pc f4_name_pc, f4.shortname f4_shortname, "
            . "f4.fias_id f4_fias_id, f4.level f4_level, f4.parent_id f4_parent_id";
    }
    ...
    public function getFias($filter) {
        ...
        if (!empty($filter['city_name'])) {
            ...
            return $this->db->query("
                SELECT f1.offname f1_name, f1.offname_gc f1_name_gc, f1.offname_pc f1_name_pc, f1.level f1_level, f1.fias_id f1_fias_id
                FROM fias f1
